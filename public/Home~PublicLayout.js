(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["Home~PublicLayout"],{
      ...
      _c(
        ...
        _vm._l(_vm.products, function(product, i) {
          return _c("slide", { key: i, staticClass: "slide" }, [
            _c("img", {
              staticClass: "picture",
              attrs: { src: "/storage/img/" + product.image }
            }),
            _vm._v(" "),
            _c("span", { staticClass: "text" }, [_vm._v(_vm._s(product.name))])
          ])
        }),
        1
      )
